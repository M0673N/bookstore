...
```
##### Make sure to add your .env file to the bookstore folder. You will need a Cloudinary account, Gmail account (setup properly) and PostgreSQL provider account.
```
cd ./bookstore/ &&
python3 -m venv .venv &&
