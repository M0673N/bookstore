...
urlpatterns = [
    ...
    path(
        "article-details/<int:pk>",
        views.ArticleDetailsView.as_view(),
    ...
    path(
        "comment-article/<int:pk>",
        views.CommentArticleView.as_view(),
        name="comment article",
    ),
    path(
        "delete-article-comment/<int:apk>/<int:cpk>",
        views.DeleteArticleCommentView.as_view(),
